...
# NOTE: Default ICE servers
# TODO: Is it possible to host default RTC/ICE server locally?
...
def object_detection():
    ...
    def player():
        return MediaPlayer(str(Path(__file__).parent / f"data/{_ext_file.name}"))
    ...
    webrtc_ctx = None
    if not st.checkbox('Use external file?', value=False):
        ...
        _ext_file = st.file_uploader('Choose video file')
